...
@interface ECDACircularProgressLayer : CALayer
...
@implementation ECDACircularProgressLayer
...
@interface ECDACircularProgressView ()<CAAnimationDelegate>

@end

@implementation ECDACircularProgressView

+ (void) initialize
{
    if (self == [ECDACircularProgressView class]) {
        ECDACircularProgressView *circularProgressViewAppearance = [ECDACircularProgressView appearance];
...
+ (Class)layerClass
{
    return [ECDACircularProgressLayer class];
}

- (ECDACircularProgressLayer *)circularProgressLayer
{
    return (ECDACircularProgressLayer *)self.layer;
}
